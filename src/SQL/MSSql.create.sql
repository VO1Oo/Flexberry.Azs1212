...
CREATE TABLE [Состав] (
	 ...
	 [Пистолет] UNIQUEIDENTIFIER  NOT NULL,

	 [Колонка] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [РегистОстатков] (
	 ...
	 [Резервуар] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [Пистолет] (
	 ...
	 [СправочникЦен] UNIQUEIDENTIFIER  NOT NULL,
