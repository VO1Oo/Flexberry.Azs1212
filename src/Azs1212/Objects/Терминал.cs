...
namespace IIS.Azs1212
{
    ...
    public class Терминал : ICSSoft.STORMNET.DataObject
    {
        ...
        [PropertyStorage(new string[] {
                "Азс"})]
        [NotNull()]
        public virtual IIS.Azs1212.Азс Азс
        {
            get
            {
                ...
                IIS.Azs1212.Азс result = this.fАзс;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТерминалE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТерминалE", typeof(IIS.Azs1212.Терминал));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТерминалL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТерминалL", typeof(IIS.Azs1212.Терминал));
                }
            }
        }
    }
